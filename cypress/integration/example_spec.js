...
describe('Kitchen Sink', () => {
    ...
    context('Traversal', () => {
        ...
        it('.next() - get next sibling DOM element', () => {
            ...
            cy.get('.traversal-ul').contains('apples')
                .next()
        ...
        it('.not() - remove DOM elements from set of DOM elements', () => {
            ...
            cy.get('.traversal-disabled .btn').not('[disabled]')
        ...
        it('.parentsUntil() - get parent DOM elements from DOM elements until el', () => {
            ...
            cy.get('.clothes-nav').find('.active')
        ...
        it('.siblings() - get all sibling DOM elements', () => {
            ...
            cy.get('.traversal-pills .active').siblings()
                .should('have.length', 2);
        });
    });
    ...
    context('Actions', () => {
        ...
        it('.blur() - blur off a DOM element', () => {
            ...
            cy.get('.action-blur').type('I\'m about to blur')
                .blur()
...
.value();
        ...
        it('Cypress.moment() - format or parse dates using a moment method', () => {
            ...
            const time = Cypress.moment().utc('2014-04-25T19:38:53.196Z')
.format('h:mm A');
